...
/**
 * Config file directory for dictionary and params files
 * 
 * The dictionary file is used to find the character table.
 * The parameters file is used to find the dictionary configuration information.
 *
 * @param directory character table container
 *
 * @author yu.zuo 2019.12.12
 */
OPENCC_EXPORT void opencc_config(const char* directory);
